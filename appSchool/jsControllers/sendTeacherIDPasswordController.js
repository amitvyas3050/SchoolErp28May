var sendTeacherIDPasswordController = {
    ...
    splitterResized: function (s, e) {
        switch (e.pane.name) {
            ...
            case 'SendMessegeWishesFooter':
                GridSendTeacherIDPassword.SetHeight(e.pane.GetClientHeight());
                break;
    ...
    RowSelectionChange: function OnGridFocusedRowChanged(s, e) {
        ...
        s.GetRowValues(s.GetFocusedRowIndex(), 'TemplateID', sendTeacherIDPasswordController.RefreshTabsView);
    },

    SelectedTemplate: function (s, e) {

        var templateid = s.GetValue();
        sendTeacherIDPasswordController.RefreshTabsView(templateid);
    },
    ...
    RefreshTabsView: function (values) {
        ...
        $.ajax({
            url: "/SendTeacherIDPassword/GetTemplateMesssageText",
            type: "POST",
    ...
    SelectionChanged: function (s, e) {
        ...
        s.GetSelectedFieldValues("MobileNo", sendTeacherIDPasswordController.GetSelectedFieldValuesCallback);
        s.GetSelectedFieldValues("TeacherID", sendTeacherIDPasswordController.GetSelectedFieldValuesCallbackForStudentID);
    ...
    ClickLoadGrid: function (s, e) {
        ...
        $.ajax({
            url: "/SendTeacherIDPassword/GetStudentListForSMS",
            type: "POST",
